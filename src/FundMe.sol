...
contract FundMe {
    ...
    //Pure and view fuctions

    function getaddressToAmountFunded(address user) view external returns(uint256){
        return addressToAmountFunded[user];
    }

    function getFundersAddress(uint256 index) view external returns(address){
